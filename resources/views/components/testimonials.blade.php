...
<div class="flex justify-center overflow-x-hidden relative  ">
            ...
            <div class="swiper-wrapper">
                ...
                @foreach (__('testimonial.slider') as $index => $testimonial)
                    <div class="swiper-slide">
                        <div class="slide-content card h-[400px] w-[300px] bg-white border-2 border-blue-600 p-4 rounded-lg relative ">
    ...
    <style>
        .swiper-pagination {
            position: absolute;
            bottom: 0px;  /* Moves the pagination 10px from the bottom */
            left: 50%;
            transform: translateX(-50%);
            z-index: 10;  /* Makes sure the pagination stays on top of the content */
        }
    </style>
