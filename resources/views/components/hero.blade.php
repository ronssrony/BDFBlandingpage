            ...
            <div class="p-4 mt-2">
                <div class="flex gap-3 pb-6">
                    <div class="flex gap-1 items-center justify-center px-4 py-3 bg-white rounded-sm shadow-md shadow-gray-400">
                        <div>
                            <img src="{{ asset('hero/total-orders-icon.png') }}" alt="" class="scale-85">
                        </div>
                    ...
                    <div class="flex gap-2 items-center justify-center px-4 py-3 bg-white rounded-sm shadow-md shadow-gray-400">
                        <div>
                            <img src="{{ asset('hero/readyToShip-icon.png') }}" alt="" class="scale-85">
                        </div>
                        <div class="flex flex-col">
                    ...
                    <div class="flex gap-2 items-center justify-center px-4 py-3 bg-white rounded-sm shadow-md shadow-gray-400">
                        <div>
                            <img src="{{ asset('hero/deliveredOrders-icon.png') }}" alt="" class="scale-85">
                        </div>
                        <div class="flex flex-col">
                    ...
                    <div class="flex gap-2 items-center justify-center px-4 py-3 bg-white rounded-sm shadow-md shadow-gray-400">
                        <div>
                            <img src="{{ asset('hero/total-orders2-icon.png') }}" alt="" class="scale-85">
                        </div>
                        <div class="flex flex-col">
                            <p class="text-[12px] font-bold">Total Orders</p>
                ...
                <div class="flex -ml-4">
                    ...
                    <div class="w-fit h-fit">
                        <img src="{{ asset('hero/pageView.png') }}" alt="" class="w-87 h-auto">
                    </div>
                </div>
                <div class="flex gap-5 -ml-1">
                    <div class="w-fit h-fit">
                        <img src="{{ asset('hero/orders.png') }}" alt="" class="w-82 h-auto">
                    </div>
                    <div class="w-fit h-fit">
                        <img src="{{ asset('hero/salesOverview.png') }}" alt="" class="w-82 h-auto">
                    </div>
                </div>
            </div>
        </div>
