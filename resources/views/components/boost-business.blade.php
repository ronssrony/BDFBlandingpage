<div class="grid justify-center">
    <div class=" max-w-[1200px] ">
        <div class="relative my-20">
            <img src="images/boost-business\boost-bg-small.png" alt="background" class="block md:hidden w-full">
            <img src="images/boost-business\boost-bg-large.png" alt="background" class="hidden md:block w-full">
