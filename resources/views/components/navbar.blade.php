...
<nav class="navbar  fixed top-0 z-[9999] min-w-full flex justify-center  max-h-[70px]  items-center min-h-[70px] transition-all duration-300 ">
    <div class=" transition-all duration-400 flex bg-orange-400 justify-between items-center  mx-auto max-w-[1300px] lg:max-w-[1005px] xl:max-w-[1160px] min-[1300px]:max-w-[1256px] 2xl:max-w-[1300px] w-[100%] lg:w-[100%] xl:w-[100%] 2xl:w-[100%] py-3 px-4">
