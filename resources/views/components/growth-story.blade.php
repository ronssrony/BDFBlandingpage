...
<div>
    ...
    style="background-image: url('/images/Group 427321952 (1) 1.png'); background-size: cover; background-position: center; background-repeat: no-repeat;">
      ...
      <div class="relative lg:relative md:relative md:w-11/12 lg:w-11/12 lg:mt-45 md:mx-auto lg:mx-auto ">
        ...
        <div class="lg:flex md:flex lg:top-2.5 md:top-2.5 lg:flex-row  md:flex-row lg:justify-between md:justify-between lg:items-center md:items-center lg:relative md:relative">
          ...
          <div class="lg:relative lg:text-center lg:w-full md:w-1/6 pb-8 mb-6 md:relative md:text-center  md:pb-8 md:mb-6">
            ...
            <div class="ml-20 mt-5 lg:ml-0 lg:-mt-52
                ...
                <div class="flex flex-col  text-gray-400 mt-4">
                    <div class="flex flex-col lg:text-[11px]  lg:flex-row lg:items-center lg:space-x-3
