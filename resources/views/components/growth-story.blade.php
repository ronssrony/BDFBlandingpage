  ...
  <div>
    ...
    style="background-image: url('/images/Group 427321952 (1) 1.png'); background-size: cover; background-position: center; background-repeat: no-repeat;">
      ...
      <div class="relative lg:relative lg:w-11/12 lg:mt-45 lg:mx-auto ">
        ...
        <div class="lg:flex lg:top-2.5 lg:flex-row md:flex-row lg:justify-between lg:items-center lg:relative">
            ...
            <div class="lg:relative lg:text-center lg:w-full md:w-1/6 pb-8 mb-6">
                ...
                <div class="ml-20 mt-5 lg:ml-0 lg:-mt-52 lg:flex lg:flex-col lg:items-center">
                    <h2 class="lg:text-2xl text-2xl text-left lg:mx-auto font-bold lg:text-center">{{ __('growth-story.year_2025.title') }}</h2>
          ...
          <div class="lg:relative lg:text-center lg:w-full md:w-1/6 pb-8 mb-6">
            ...
            <div class="ml-20 mt-5 lg:ml-0 lg:-mt-52">
                ...
                <div class="flex flex-col  text-gray-400 mt-4">
                    <div class="lg:text-[11px] flex flex-col lg:flex-row lg:items-center lg:space-x-3">
                        <div class="lg:flex flex flex-col lg:flex-row text-left lg:whitespace-nowrap">
                            <span class="font-bold text-white">{{ __('growth-story.first_launch.subtitle_1') }}</span>
                            <span class="text-left lg:ml-1 font-bold lg:text-no-wrap">{{ __('growth-story.first_launch.subtitle_2') }}</span>
                        </div>
                    </div>

                    <div class="lg:text-[12px] mt-3 flex flex-col lg:flex-row lg:items-center lg:space-x-3">
                        <div class="lg:flex lg:flex-row  flex flex-col text-left lg:whitespace-nowrap">
                            ...
                            <span class="lg:ml-1 font-bold">{{ __('growth-story.first_launch.subtitle_4') }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:relative lg:text-center lg:w-full md:w-1/6 pb-8 mb-6">
                ...
                <div class="ml-20 mt-5 lg:ml-0  lg:mt-72">
                    ...
                    <div class="paragraph_small block text-left lg:text-nowrap lg:flex {{app()->getLocale()==='bn'?'lg:flex-col':''}} lg:justify-center">
