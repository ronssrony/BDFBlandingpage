<x-layout>
    ...
    <div class="p-4 md:p-8 lg:p-10">
        ...
        <div class="">
                    ...
                    <div class="relative w-[90%] md:w-[80%] lg:w-[100%] mx-auto  p-1.5">
                        ...
                        @else
                            <img src="{{ asset('images/essential-business/section1-bg.svg') }}" alt="Image {{ $loop->index }}" class="h-[140px] w-full object-cover">
    ...
    <div class="absolute inset-0 flex flex-col justify-center items-start text-white px-5 md:px-15 lg:px-20">
        <h1 class="text-3xl md:text-4xl font-bold">Seamless Customer Support</h1>
        <p class="text-base  md:text-xl  lg:mb-5">Boost Customer Satisfaction & Resolve Issues Faster!</p>
...
<div class="relative p-5 mb-10  block md:hidden">
    ...
    <div class="absolute inset-0 flex flex-col  items-start text-white px-15 mt-[12%] ">
        <h1 class="text-[28px]  font-bold leading-tight">Seamless Customer Support</h1>
        <p class="text-base mt-2 mb-5">Boost Customer Satisfaction & Resolve Issues Faster!</p>
        @include('components.free-trail-button')
    </div>
</div>
</div>
