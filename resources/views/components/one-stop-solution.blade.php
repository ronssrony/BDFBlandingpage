...
<body>
    <div>
        <h4 class="text-[24px] font-[300] text-center">One-stop solution for all digital entrepreneurs</h4>
        <h2 class="text-[60px] font-[800] text-gray-800 text-center">Who is BD Funnel Builder For?</h2>
        <div class="p-1 flex flex-wrap items-center justify-center">
            <div class="flex-shrink-0 m-6 relative overflow-hidden bg-[#FEF5DB] rounded-lg w-[383px] h-[355px] shadow-lg">
                ...
                <h3 class="pt-10 font-[500] text-[26px] text-center">E-Commerce Entrepreneur</h3>
            </div>
            ...
            <div class="flex-shrink-0 m-6 relative overflow-hidden bg-[#FEF5DB] rounded-lg w-[383px] h-[355px] shadow-lg">
                ...
                <h3 class="pt-10 font-[500] text-[26px] text-center">Digital Business Owner</h3>
            </div>
